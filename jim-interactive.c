 ...
 */
void Jim_HistorySetCompletion(Jim_Interp *interp, Jim_Obj *completionCommandObj, Jim_Obj *hintsCommandObj)
{
#ifdef USE_LINENOISE
    struct JimCompletionInfo *compinfo = JimGetCompletionInfo(interp);
...
int Jim_InteractivePrompt(Jim_Interp *interp)
{
    ...
    Jim_HistorySetCompletion(interp,
        Jim_NewStringObj(interp, "tcl::autocomplete", -1),
        Jim_NewStringObj(interp, "tcl::autohint", -1)
        );
#endif
